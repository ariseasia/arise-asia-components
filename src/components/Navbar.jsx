...
const Navbar = ({ className, sections, lngs }) => {
  ...
  return (
    <nav className={className}>
      <div className="container flex justify-between items-center px-6 text-white rounded-full shadow-2xl bg-black/75 font-heading">
        ...
        <div className="flex gap-x-6">
          ...
          <a
            className="hidden py-1 px-4 text-sm text-black bg-white rounded-full lg:block hover:bg-gray-100"
